...
Silahkan @${m.mentionedJid[0].split`@`[0]} untuk ketik terima/tolak`
	    ...
	    case 'donasi': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
            ...
            break
            case 'rules': {
                hisoka.sendMessage(m.chat, { image: { url: 'https://telegra.ph/file/f0c0b533e9dd46ddfda3c.jpg' }, caption: `*Hai Kak ${m.pushName}*\n\nBerikut Rules Bot 🚧\n1.⭔Dilarang Spam Menu / Command, Berikan Delay 2-5 Detik!\n\n2.⭔ Dilarang Telepon Bot, Jika Menelpon Akan Diblokir Otomatis Oleh Bot\n\n3.⭔ Dilarang Chat Owner Jika Tidak Ada Kepentingan\n\n*JIKA MENELPON BOT DENGAN TIDAK SENGAJA BISA HUBUNGI OWNER UNTUK UNBLOCK NO KALIAN*` }, { quoted: m })
            }
            break
            case 'chat': {
...
⭔ Detail: ${detail}`
            ...
            let setbot = db.data.settings[botNumber]
               if (args[0] === 'templateImage'){
                ...
                let thumbdek = fs.readFileSync('./image/thumb.jpeg')
                let sections = [
                {
            ...
            case 'list': case 'menu': case 'help': case '?': {
                anu = `
Hai ${m.pushName} 👋, Saya Adalah KennBot Siap Membantu Anda, Jika Ada Bug Atau Bot Bermasalah Bisa Hubungi Owner
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
